...
alter table "public"."subscriptions" add column "cancel_at" timestamp with time zone default timezone('utc'::text, now());

alter table "public"."subscriptions" add column "cancel_at_period_end" boolean;

alter table "public"."subscriptions" add column "canceled_at" timestamp with time zone default timezone('utc'::text, now());

alter table "public"."subscriptions" add column "created" timestamp with time zone not null default timezone('utc'::text, now());

alter table "public"."subscriptions" add column "ended_at" timestamp with time zone default timezone('utc'::text, now());

alter table "public"."subscriptions" add column "metadata" jsonb;

alter table "public"."subscriptions" add column "quantity" integer;

alter table "public"."subscriptions" add column "trial_end" timestamp with time zone default timezone('utc'::text, now());

alter table "public"."subscriptions" add column "trial_start" timestamp with time zone default timezone('utc'::text, now());

alter table "public"."subscriptions" alter column "current_period_end" set default timezone('utc'::text, now());

alter table "public"."subscriptions" alter column "current_period_end" set not null;

alter table "public"."subscriptions" alter column "current_period_end" set data type timestamp with time zone using "current_period_end"::timestamp with time zone;

alter table "public"."subscriptions" alter column "current_period_start" set default timezone('utc'::text, now());

alter table "public"."subscriptions" alter column "current_period_start" set not null;

alter table "public"."subscriptions" alter column "current_period_start" set data type timestamp with time zone using "current_period_start"::timestamp with time zone;

alter table "public"."subscriptions" alter column "id" drop default;

alter table "public"."subscriptions" alter column "id" set data type text using "id"::text;
...
alter table "public"."subscriptions" alter column "status" set data type subscription_status using "status"::subscription_status;

alter table "public"."subscriptions" alter column "user_id" drop default;
